...
export function BoardDetails() {
  ...
  const isBoardModalOpen = useSelector(
    (storeState) => storeState.boardModule.isBoardModalOpen
  );
  ...
  return (
    <section className="board-details flex">
      ...
      <main className="board-main">
        ...
        {boardType === "kanban" && <GroupListKanban board={board} />}
        <BoardModal setIsMouseOver={setIsMouseOver} />
        {boardType === "dashboard" && <Dashboard />}
      </main>
      {isCreateModalOpen && (
        <CreateBoard setIsModalOpen={setIsCreateModalOpen} />
      )}
      {(isInviteModalOpen ||
        isCreateModalOpen ||
        (isBoardModalOpen && isMouseOver)) && (

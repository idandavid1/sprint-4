...
function getFilteredBoard(board, filterBy = getDefaultFilterBoard()) {
  ...
  if (filterBy.title) {
    ...
    const groups = filteredBoard.groups.filter((group) =>
  ...
  if (filterBy.memberId) {
    ...
    groups.forEach((group) => {
      group.tasks = group.tasks.filter((task) =>
        task.memberIds.includes(filterBy.memberId)
      );
    });
  }
...
function getEmptyComment() {
  return {
    ...
    byMember: {
      ...
      fullname: "Guest",
      imgUrl:
        "https://res.cloudinary.com/du63kkxhl/image/upload/v1675013009/guest_f8d60j.png",
    },
    txt: "",
    style: {
      textDecoration: "none",
...
function getEmptyBoard() {
  return {
    ...
    createdBy: {
      ...
      imgUrl:
        "https://res.cloudinary.com/du63kkxhl/image/upload/v1674069496/me_dpbzfs.jpg",
    ...
    members: [
      {
        ...
        imgUrl:
          "https://res.cloudinary.com/du63kkxhl/image/upload/v1673788222/cld-sample.jpg",
      },
      {
        _id: "m102",
        fullname: "Idan David",
        imgUrl:
          "https://res.cloudinary.com/du63kkxhl/image/upload/v1673820094/%D7%A2%D7%99%D7%93%D7%9F_jranbo.jpg",
      },
      {
        _id: "m103",
        fullname: "Ofek Tarablus",
        imgUrl:
          "https://res.cloudinary.com/du63kkxhl/image/upload/v1674069458/image_exxnux.png",
      },
      {
        _id: "m104",
